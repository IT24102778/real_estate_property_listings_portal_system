    ...
    <form id="loginForm" action="login" method="POST">
        ...
        <div class="social-login">
            ...
            <div class="social-icons">
                ...
                <a href="https://mail.google.com/mail/u/0/?hl=en" class="social-icon google"><i class="fab fa-google"></i></a>
        ...
        <p class="form-footer">
            ...
            <a href="forgotPassword.jsp" style="margin-top: 5px; display: inline-block;">Forgot password?</a>
        </p>
    </form>
</div>
